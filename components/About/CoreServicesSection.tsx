          ...
          {[0, 1, 2, 3].map((index) => {
            ...
            return (
              <motion.div
                key={index}
                variants={item}
                className="bg-white !border-t-slate-500 p-4 md:p-8 rounded-[2rem] shadow-xl border border-gray-100 relative overflow-hidden flex flex-col items-center text-center h-full"
              ...
              >
                ...
                <div className="absolute -bottom-10 -right-10 w-24 h-24 rounded-full opacity-5 pointer-events-none bg-gray-400" />
              </motion.div>
            );
          })}
        </motion.div>
