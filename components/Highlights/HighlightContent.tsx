...
export default function HighlightContent({
  ...
  return (
    ...
    >
      ...
      <h3 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 mb-4 leading-tight tracking-tight">
        {title}
      </h3>
      ...
      <div className="group/btn inline-flex items-center gap-3 w-fit">
        <span className="relative inline-flex items-center gap-2 px-4 py-2 bg-gray-800 text-white rounded-full font-medium text-sm overflow-hidden transition-all duration-300 hover:bg-gray-700 hover:shadow-lg hover:shadow-gray-900/25">
