        ...
        <form onSubmit={handleSubmit} className="gap-6 flex flex-col">
          ...
          <div>
            <label className="block text-sm font-bold text-gray-700 mb-4 flex items-center gap-2">
              <HiCloudUpload className="text-lg text-blue-500" /> Event Cover
              Image
            </label>
            <div
              {...getRootProps()}
          ...
          <div className="pt-6 border-t border-gray-100 bg-gray-50 p-6 rounded-2xl">
            ...
            />
            <p className="text-[12px] text-gray-400 mt-1">
              If provided, a &quot;Register Now&quot; button will appear on the
              event page.
            </p>
          </div>
          {/* Submit Buttons */}
